...
class SaveImageDialog(QDialog):
    ...
    def __init__(self, parent: QWidget, img_width: int, img_height: int, filename: str):
        ...
        options_group_box = QGroupBox(self.tr("Options"), self)
        options_group_box_layout = QVBoxLayout(options_group_box)
        self.proportional_checkbox = QCheckBox(self.tr("Proportional size"), options_group_box)
        ...
        options_size_layout.addWidget(QLabel(self.tr("Width:"), self))
        self.width_spinbox = QSpinBox(options_group_box)
        self.width_spinbox.setSuffix(self.tr(" pixels"))
        ...
        options_size_layout.addWidget(QLabel(self.tr("Height:"), self))
        self.height_spinbox = QSpinBox(options_group_box)
        self.height_spinbox.setSuffix(self.tr(" pixels"))
        ...
        message = QLabel(self.tr("Output file:"))
        ...
        self.file_path_button = QPushButton(self.tr("Browse..."))
