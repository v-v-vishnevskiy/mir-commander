...
from .graphics_nodes.base import BaseGraphicsNode
from .graphics_nodes.coordinate_axes import Axis, CoordinateAxes
from .graphics_nodes.molecule import Molecule
from .graphics_nodes.molecules import Molecules
from .graphics_nodes.volume_cube.volume_cube import VolumeCube as VolumeCubeGraphicsNode
from .save_image_dialog import SaveImageDialog
from .shaders import fragment, vertex
...
class Visualizer(OpenGLWidget):
    ...
    def init_shaders(self):
        ...
        self.resource_manager.add_shader(
            "atom_label", ShaderProgram(VertexShader(vertex.ATOM_LABEL), FragmentShader(fragment.ATOM_LABEL))
        )
