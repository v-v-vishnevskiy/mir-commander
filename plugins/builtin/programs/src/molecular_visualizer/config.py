...
from mir_commander.core.config import CyFunctionDetector
from mir_commander.ui.sdk.opengl.config import ProjectionConfig
from mir_commander.ui.sdk.opengl.text_overlay import TextOverlayConfig
...
class AtomLabelConfig(BaseModel):
    ...
    font: str = "default"
    offset: float = Field(default=0.4, ge=0.01, le=10.0)
